...
public class ScheduleController {
    ...
    @PostMapping()
    public ApiResponse<ScheduleCreateResponseDto> createSchedule(@RequestBody ScheduleCreateRequestDto scheduleCreateRequestDto) {
        ScheduleCreateResponseDto createSchedule = scheduleService.createSchedule(scheduleCreateRequestDto);
