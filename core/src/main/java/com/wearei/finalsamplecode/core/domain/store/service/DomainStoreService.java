...
public class DomainStoreService {
    ...
    public Store createStore(Long userId, Long groundId, String storeName, LocalTime openedAt, LocalTime closedAt) {
        ...
        Preconditions.validate(!storeRepository.existsByStoreNameAndGround(storeName,ground),ErrorStatus._STORE_ALREADY_EXISTS);
    ...
    public Store checkStore(Long storeId){
        ...
        Preconditions.validate(!store.isDeleted(), ErrorStatus._NOT_FOUND_STORE);
